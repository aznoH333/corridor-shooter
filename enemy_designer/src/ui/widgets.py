...
_CHECKER_A = (0x00, 0x4C, 0x33, 255)
_CHECKER_B = (0x00, 0x32, 0x35, 255)
...
def _pixel_art_preview_rgba(
    ...
    checker = _make_checkerboard(source_w, source_h)
